        ...
        <div className="modal-card">
          ...
          <form onSubmit={handleSubmit}>
            <section className="modal-card-body">
              ...
              <h1>OU</h1>
              <div className="field">
                <label htmlFor="last_name" className="label">Nom
                </label>
                <p className="control">
                  <input className="input" type="text" name="last_name" placeholder="Nom" value={last_name} onChange={handleLastName} />
            ...
            <footer className="modal-card-foot">
              <button className="button is-success" type="submit">S'inscrire</button>
